                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.blog.blogs') }}"
                                class="nav-link {{ $current_route == 'admin.blog.blogs' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    My Blogs
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.feedback.show') }}"
                                class="nav-link {{ $current_route == 'admin.feedback.show' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    My Feedback
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.product.index') }}"
                                class="nav-link {{ $current_route == 'admin.product.index' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Product
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.product.orders') }}"
                                class="nav-link {{ $current_route == 'admin.product.orders' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Orders
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.doctor.index') }}"
                                class="nav-link {{ $current_route == 'admin.doctor.index' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Doctor
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.city.index') }}"
                                class="nav-link {{ $current_route == 'admin.city.index' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    City
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.appointment.index') }}"
                                class="nav-link {{ $current_route == 'admin.appointment.index' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Manage Appointment
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.appointment.history') }}"
                                class="nav-link {{ $current_route == 'admin.appointment.history' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Appointment History
                                </p>
                        ...
                        <li class="nav-header">Weekly CMS</li>
                        <li class="nav-item">
                            <a href="{{ route('admin.week.index') }}"
                                class="nav-link {{ $current_route == 'admin.weekly.index' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Weekly
                                </p>
