                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex justify-content-end p-2">
                            <a class="btn btn-success" href="{{ route('admin.doctor.add') }}"> <i class="fa fa-plus"></i>
                                Add</a>
                        </div>
                        <div class="card">
                                                    ...
                                                    <div class="row">
                                                        <div>
                                                            <a class="btn btn-success"
                                                                href="{{ route('admin.doctor.edit', $item->id) }}"> <i
                                                ...
                                                <div class="modal-dialog " role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('admin.doctor.delete', $item->id) }}"
